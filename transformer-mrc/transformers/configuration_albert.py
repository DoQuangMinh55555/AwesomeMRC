...
ALBERT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    'albert-base-v1': "https://huggingface.co/albert-base-v1/blob/main/config.json",
    'albert-large-v1': "https://huggingface.co/albert-large-v1/blob/main/config.json",
    'albert-xlarge-v1': "https://huggingface.co/albert-xlarge-v1/blob/main/config.json",
    'albert-xxlarge-v1': "https://huggingface.co/albert-xxlarge-v1/blob/main/config.json",
